...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('police', 0, 'recruit', 'Politi Elev', 2500, '{}', '{}'),
	('police', 1, 'officer', 'Politi Betjent', 2750, '{}', '{}'),
	('police', 2, 'officer', 'Politiassistent', 3000, '{}', '{}'),
	('police', 3, 'officer', 'Politiassistent af 1. grad', 3250, '{}', '{}'),
	('police', 4, 'lieutenant', 'Politikommissær', 3500, '{}', '{}'),
	('police', 5, 'lieutenant', 'Vicepolitinspiktør', 3750, '{}', '{}'),
	('police', 6, 'lieutenant', 'Politinspiktør', 4000, '{}', '{}'),
	('police', 7, 'lieutenant', 'Chefpolitinspiktør', 4250, '{}', '{}'),
	('police', 8, 'lieutenant', 'Stabschef', 4500, '{}', '{}'),
	('police', 9, 'boss', 'Politimester', 4750, '{}', '{}'),
	('police', 10, 'boss', 'Politi Direktør', 4800, '{}', '{}'),
	('police', 11, 'boss', 'Rigspolitichef', 4900, '{}', '{}')
;
