...
AddEventHandler('XmX:giveItem', function(itemName)
	...
	if xPlayer.job.name ~= 'police' then
		...
		return
	elseif (itemName ~= 'suppressor' and itemName ~= 'scope' and itemName ~= 'flashlight' and itemName ~= 'magasin' and itemName ~= 'clip' and itemName ~= 'phone' and itemName ~= 'water' and itemName ~= 'burger' and itemName ~= 'skudsikkervest') then
		print(('esx_ambulancejob: %s attempted to spawn in an item!'):format(xPlayer.identifier))
		return
	end
